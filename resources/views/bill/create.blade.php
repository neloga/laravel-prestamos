                ...
                <div class="col-md-12 col-lg-8 offset-lg-2">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">REGISTRAR GASTO</h4>
                        ...
                        <div class="widget-body">
                            ...
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="type_bill"><b>TIPO:</b></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="description"><b>DETALLE</b></label>
                                        <textarea name="description" id="description" class="form-control" id="" maxlength="100" cols="30" rows="4"></textarea>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-12"><button type="submit" class="btn btn-success btn-block btn-md"><b>GUARDAR</b></button></div>
                                </div>
                            </form>
                        </div><!-- .widget-body -->
                    </div><!-- .widget -->
