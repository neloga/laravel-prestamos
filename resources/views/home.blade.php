...
@section('agent-section')
    <div class="col-md-3 col-sm-6">
        <a href="{{url('client/create')}}">
            <div class="widget stats-widget">
                <div class="widget-body clearfix h-100 bg-warning">
                    <div class="">
                        <h3 class="widget-title text-white">Nuevo Cliente</h3>
                    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <a href="{{url('client')}}">
            <div class="widget stats-widget">
                <div class="widget-body clearfix h-100 bg-primary">
                    <div class="">
        ...
        <a href="{{url('supervisor/agent')}}">
            <div class="widget stats-widget">
                <div class="widget-body clearfix bg-warning">
                    ...
                    <span class="pull-right watermark"><i class="fa fa-dollar"></i></span>
                </div>
            </div><!-- .widget -->
        </a>
